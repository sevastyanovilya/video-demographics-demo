...
Этот проект предоставляется «как есть» без каких‑либо гарантий.  Вы
можете свободно использовать и модифицировать код для обучения и
не‑коммерческих проектов.  Исходный репозиторий автора
`IlyaGenShubin/VSR` послужил вдохновением, но вся логика в этой
версии написана заново.